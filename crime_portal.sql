...
(1, 123214521452, 'jaipur', 'Robbery', '2018-12-06', 'My Home has been Robbed.', 'Assigned', 'ChargeSheet Filed', 't101');
INSERT INTO `complaint` (`c_id`, `a_no`, `location`, `type_crime`, `d_o_c`, `description`, `inc_status`, `pol_status`, `p_id`) VALUES
(2, 123214521452, 'hindupur', 'kidnapping', '2018-11-06', 'My son got kidnapped.', 'Assigned', 'ChargeSheet Filed', 'a102');
...
('rashmi@gmail.com', 'head');
INSERT INTO `head` (`h_id`, `h_pass`) VALUES
('nikhitha@gmail.com', 'head1');
...
('Manish Singh', 'a101', 'Murder', 'hindupur', 'manish'),
('Jay Singh', 'a102', 'All', 'hindupur', 'jay'),
('Suvendu Ghosh', 't101', 'Robbery', 'jaipur', 'suvendu');
...
('shah@anandapur', 'Shahbaz', 'hindupur', 'shahbaz'),
('shivam@tollygunge', 'Shivam', 'jaipur', 'shivam');
